# Addressing R3C1 and R3C7 - Kindey (ncem V2) - TLS border
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/NCEM/linear_results_parallel/xenium_old_kidney/'
save_dir = '/nfs/team361/ms83/data/kidney/xenium_ncem/analysis/'
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/ncem/analysis/kidney_TLSborder_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_ncem_spl_clusters_TLSborder_V2.h5ad')
