# Addressing R3C1 and R3C7 - Beacon (ncem V2) - T cells superficial
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/NCEM/linear_results_parallel/xenium_old_beacon/'
save_dir = '/nfs/team361/ms83/data/skin/xenium_ncem/xenium_old_beacon/analysis/'

adata = sc.read_h5ad(initDir + 'combined_linear_ncem_full.h5ad')
adata
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_ncem"
        
        sc.pp.neighbors(adata, use_rep="ncem_niche", n_neighbors=k, key_added=neighbors_key)
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/ncem/analysis/beacon_Tcells_superficial_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_ncem_spl_clusters_Tcells_superficial.h5ad')
