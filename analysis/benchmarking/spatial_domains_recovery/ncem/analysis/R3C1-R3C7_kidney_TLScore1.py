# Addressing R3C1 and R3C7 - Kindey (ncem V2) - TLS core 1
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/ncem/analysis/kidney_TLSscore1_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_ncem_spl_clusters_TLScore1_V2.h5ad')
