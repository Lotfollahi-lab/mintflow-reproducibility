# Addressing R3C1 and R3C7 - Beacon (utag V2) - T cells superficial
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/reconstructed_h5ad/xenium_old_beacon/'
save_dir = '/nfs/team361/ms83/data/skin/xenium_utag/analysis/'

adata = sc.read_h5ad(initDir + 'combined_utag.h5ad')
adata
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_utag"
        
        sc.pp.neighbors(adata, use_rep="X_pca", n_neighbors=k, key_added=neighbors_key)
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/utag/analysis/beacon_Tcells_superficial_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_utag_spl_clusters_Tcells_superficial.h5ad')
