# Addressing R3C1 and R3C7 - Kindey (utag V2) - T_DC Niche 
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/utag/analysis/beacon_T_DC_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_utag_spl_clusters_T_DC_V3.h5ad')
