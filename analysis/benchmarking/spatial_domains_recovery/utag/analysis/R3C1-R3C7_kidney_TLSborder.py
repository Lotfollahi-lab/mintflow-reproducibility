# Addressing R3C1 and R3C7 - Kindey (utag V2) - TLS border
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/reconstructed_h5ad/xenium_old_kidney/'
save_dir = '/nfs/team361/ms83/data/kidney/xenium_utag/analysis/'
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/utag/analysis/kidney_TLSborder_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_utag_spl_clusters_TLSborder_V2.h5ad')
