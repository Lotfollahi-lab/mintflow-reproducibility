# Addressing R3C1 and R3C7 - Kindey (STAGATE V2) - TLS border
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/STAGATE/results/xenium_old_kidney/'
save_dir = '/nfs/team361/ms83/data/kidney/xenium_STAGATE/analysis/'
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/STAGATE/analysis/kidney_TLSborder_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_STAGATE_spl_clusters_TLSborder_V2.h5ad')
