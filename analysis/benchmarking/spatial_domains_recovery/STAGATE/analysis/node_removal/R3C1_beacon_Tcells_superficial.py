# Addressing R3C1 - Beacon (STAGATE V2) - T cells superficial
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/STAGATE/without_centre/results/xenium_old_beacon/'
save_dir = '/nfs/team361/ms83/data/skin/xenium_stagate/analysis/'

adata = sc.read_h5ad(initDir + 'stagate_full.h5ad')
adata
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_STAGATE"
        
        sc.pp.neighbors(adata, use_rep="STAGATE", n_neighbors=k, key_added=neighbors_key)
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/STAGATE/analysis/node_removal/beacon_Tcells_superficial_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_STAGATE_no_center_spl_clusters_Tcells_superficial.h5ad')
