# Addressing R3C1 - Beacon (STAGATE V2) - T_DC Niche 
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/STAGATE/analysis/node_removal/beacon_T_DC_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_STAGATE_no_center_spl_clusters_T_DC_V3.h5ad')
