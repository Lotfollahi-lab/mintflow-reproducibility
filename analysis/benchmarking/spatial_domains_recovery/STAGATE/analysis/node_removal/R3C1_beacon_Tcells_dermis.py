# Addressing R3C1 - Beacon (STAGATE V2) - T cells dermis
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/STAGATE/analysis/node_removal/beacon_Tcells_dermis_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_STAGATE_no_center_spl_clusters_Tcells_dermis.h5ad')
