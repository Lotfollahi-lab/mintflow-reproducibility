...
# BSUB -J TLS_core1
# BSUB -o TLS_core1_%J.out
# BSUB -e TLS_core1_%J.err

source ~/.bashrc
module load cellgen/conda
conda activate /software/cellgen/team361/ms83/envs/mintflow-revision/
python /nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/STAGATE/analysis/R3C1-R3C7_kidney_TLScore1.py
