# Addressing R1C0 - Beacon - 500 hvg - T_DC Niche 
...
initDir = '/nfs/team361/ms83/data/skin/xenium_mintflow/Outputs_nb1_500genes/adata_output/'
save_dir = '/nfs/team361/ms83/data/skin/xenium_mintflow/analysis/'
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_500hvg"
...
results_df
results_df.to_csv('500hvg_T_DC_metrics.csv')
...
plt.tight_layout()
plt.savefig('T_DC_500hvg_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('T_DC_500hvg_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()

adata.write_h5ad(save_dir + 'adata_mintflow_checkpoint_19_500hvg_spl_clusters.h5ad')
...
plt.tight_layout()
plt.savefig('T_DC_500hvg_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
