# Addressing R3C1 and R3C7 - Kindey (graphST V2) - TLS border
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/graphST/analysis/kidney_TLSborder_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_graphST_spl_clusters_TLSborder_V2.h5ad')
