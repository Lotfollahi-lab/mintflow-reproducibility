...
# # New notebook to run mintflow on xenium lesional psoriasis revised by Akbar - Skin xenium
# 

# NB (to be converted to py) to train mintflow on xenium.
# 
...
list_fname_anndata = [
    '/nfs/team361/ms83/data/skin/psoriasis/CE3-SKI-24-FO-1-S22-A1_Lesional_Psoriasis_rawformintflow.h5ad'
]
...
config_data_train['list_tissue']['anndata1']['obskey_cell_type'] = 'lvl2_annotation'
...
config_data_train['list_tissue']['anndata1']['config_dataloader_train']['width_window'] = 123
...
config_data_evaluation['list_tissue']['anndata1']['obskey_cell_type'] = 'lvl2_annotation'
...
config_data_evaluation['list_tissue']['anndata1']['config_dataloader_test']['width_window'] = 123
...
config_training['wandb_run_name'] = 'CE3-SKI-24-FO-1-S22-A1_lesional_29_Dec'
...
path_output_files = "/nfs/team361/ms83/data/skin/xenium_mintflow/Outputs_nb1/CE3-SKI-24-FO-1-S22-A1_Lesional_Psoriasis/"
