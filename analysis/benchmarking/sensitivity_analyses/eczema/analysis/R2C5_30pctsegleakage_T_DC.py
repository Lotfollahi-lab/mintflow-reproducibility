...
initDir = '/nfs/team361/sb75/mintflow-reproducibility/artifacts/benchmarking/results/sensitivity_analysis/eczema/30pctsegleakage/adata_output/'
save_dir = '/nfs/team361/sb75/mintflow-reproducibility/artifacts/benchmarking/results/sensitivity_analysis/eczema/30pctsegleakage/analysis/'
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_30pctsegleakage"
...
results_df
results_df.to_csv(save_dir + '30pctsegleakage_T_DC_metrics.csv')
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_30pctsegleakage_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_30pctsegleakage_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()

adata.write_h5ad(save_dir + 'adata_mintflow_checkpoint_19_30pctsegleakage_spl_clusters.h5ad')
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_30pctsegleakage_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
