# Addressing R2C5 - Beacon - T_DC Niche 
...
initDir = '/nfs/team361/sb75/mintflow-reproducibility/artifacts/benchmarking/results/sensitivity_analysis/eczema/20pctsegleakage/adata_output/'
save_dir = '/nfs/team361/sb75/mintflow-reproducibility/artifacts/benchmarking/results/sensitivity_analysis/eczema/20pctsegleakage/analysis/'

adata = sc.read_h5ad(initDir + 'adata_mintflow_checkpoint_19.h5ad')
adata

# Load the annotations
spatial_niche_df = pd.read_csv("/lustre/scratch126/cellgen/lotfollahi/ms83/to_share/spatial_skin_niche_annotations.csv")
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_20pctsegleakage"
...
results_df
results_df.to_csv(save_dir + '20pctsegleakage_T_DC_metrics.csv')
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_20pctsegleakage_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_20pctsegleakage_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()

adata.write_h5ad(save_dir + 'adata_mintflow_checkpoint_19_20pctsegleakage_spl_clusters.h5ad')
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_20pctsegleakage_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
