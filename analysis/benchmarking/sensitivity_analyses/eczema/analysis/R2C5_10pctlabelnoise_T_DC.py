...
results_df
results_df.to_csv(save_dir + '10pctlabelnoise_T_DC_metrics.csv')
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_10pctlabelnoise_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_10pctlabelnoise_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_10pctlabelnoise_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
