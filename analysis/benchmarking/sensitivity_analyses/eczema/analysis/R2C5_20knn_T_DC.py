...
initDir = '/nfs/team361/sb75/mintflow-reproducibility/artifacts/benchmarking/results/sensitivity_analysis/eczema/20knn/adata_output/'
save_dir = '/nfs/team361/sb75/mintflow-reproducibility/artifacts/benchmarking/results/sensitivity_analysis/eczema/20knn/analysis/'
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_20knn"
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_20knn_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_20knn_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()

adata.write_h5ad(save_dir + 'adata_mintflow_checkpoint_19_20knn_spl_clusters.h5ad')
...
plt.tight_layout()
plt.savefig(save_dir + 'T_DC_20knn_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
