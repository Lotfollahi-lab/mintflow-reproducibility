...
plt.tight_layout()
plt.savefig('T_DC_20knn_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('T_DC_20knn_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('T_DC_20knn_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
