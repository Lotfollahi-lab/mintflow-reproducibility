...
config_data_train = {'list_tissue': {'anndata{}'.format(idx_conf+1):conf for idx_conf, conf in enumerate(config_data_train)}}
config_data_evaluation = {'list_tissue': {'anndata{}'.format(idx_conf+1):conf for idx_conf, conf in enumerate(config_data_evaluation)}}
