# Addressing R3C1 and R3C7 - Beacon (graphST V2) - T cells superficial
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/GraphST/results/xenium_old_beacon/'
save_dir = '/nfs/team361/ms83/data/skin/xenium_graphst/analysis/'

adata = sc.read_h5ad(initDir + 'xenium_old_beacon_graphst.h5ad')
adata
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/graphST/analysis/beacon_Tcells_superficial_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_graphST_spl_clusters_Tcells_superficial.h5ad')
