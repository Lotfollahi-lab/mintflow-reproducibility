# Addressing R3C1 and R3C7 - Beacon (ncem V2) - T cells dermis
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/ncem/analysis/beacon_Tcells_dermis_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_ncem_spl_clusters_Tcells_dermis.h5ad')
