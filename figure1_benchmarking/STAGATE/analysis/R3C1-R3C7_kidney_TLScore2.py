# Addressing R3C1 and R3C7 - Kindey (STAGATE V2) - TLS core 2
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/STAGATE/analysis/kidney_TLScore2_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_STAGATE_spl_clusters_TLScore2_V2.h5ad')
