# Addressing R3C1 and R3C7 - Beacon (STAGATE V2) - T cells superficial
...
initDir = '/lustre/scratch126/cellgen/lotfollahi/dv8/mint_flow_bench/STAGATE/results/xenium_old_beacon/'
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/STAGATE/analysis/beacon_Tcells_superficial_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_STAGATE_spl_clusters_Tcells_superficial.h5ad')
