# Addressing R3C1 and R3C7 - Beacon (cellcharter V2) - T cells superficial
...
initDir = '/nfs/team361/ms83/data/skin/xenium_cellcharter/'
save_dir = '/nfs/team361/ms83/data/skin/xenium_cellcharter/analysis/'

adata = sc.read_h5ad(initDir + 'adata_beacon_all_preprocessed_cellcharter_emb.h5ad')
adata
...
results_df
results_df.to_csv('/nfs/users/nfs_m/ms83/mintflow-revision/benchmarking/cellcharter/analysis/beacon_Tcells_superficial_metrics.csv')
...
adata.write_h5ad(save_dir + 'adata_cellcharter_spl_clusters_Tcells_superficial.h5ad')
