...
# # New notebook to run mintflow on VisiumHD revised by Akbar - P1
# 
...
list_fname_anndata = [
    '/nfs/team361/ms83/data/CRC/visiumHD_mintflow/raw_data/adata_sc_P1_rawformintflow_7K_svg.h5ad',
...
config_training['wandb_run_name'] = 'visiumHD_P1_7K_ 12_Jan'
