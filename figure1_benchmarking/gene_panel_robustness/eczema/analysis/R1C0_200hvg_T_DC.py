# Addressing R1C0 - Beacon - 200 hvg - T_DC Niche 
...
initDir = '/nfs/team361/ms83/data/skin/xenium_mintflow/Outputs_nb1_200genes/adata_output/'
...
for i in res: 
    for k in knn:
        ...
        cluster_key = f"{i}_{k}_cluster_200hvg"
...
results_df
results_df.to_csv('200hvg_T_DC_metrics.csv')
...
plt.tight_layout()
plt.savefig('T_DC_200hvg_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('T_DC_200hvg_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()

adata.write_h5ad(save_dir + 'adata_mintflow_checkpoint_19_200hvg_spl_clusters.h5ad')
...
plt.tight_layout()
plt.savefig('T_DC_200hvg_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
