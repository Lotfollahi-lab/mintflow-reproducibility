# Addressing R1C0 - Kidney - 1000 hvg - TLS border
...
results_df
results_df.to_csv('1000hvg_TLSborder_metrics.csv')
...
plt.tight_layout()
plt.savefig('TLSborder_1000hvg_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('TLSborder_1000hvg_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()

adata.write_h5ad(save_dir + 'adata_mintflow_checkpoint_49_1000hvg_spl_clusters.h5ad')
...
plt.tight_layout()
plt.savefig('TLSborder_1000hvg_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
