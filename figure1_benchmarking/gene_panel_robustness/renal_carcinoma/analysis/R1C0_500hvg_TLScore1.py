# Addressing R1C0 - Kidney - 500 hvg - TLS Core 1
...
results_df
results_df.to_csv('500hvg_TLScore1_metrics.csv')
...
plt.tight_layout()
plt.savefig('TLScore1_500hvg_recovery_metrics.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('TLScore1_500hvg_recovery_boxplots.pdf', dpi=300, bbox_inches='tight')
plt.show()

adata.write_h5ad(save_dir + 'adata_mintflow_checkpoint_49_500hvg_TLScore1_spl_clusters.h5ad')
...
plt.tight_layout()
plt.savefig('TLScore1_500hvg_top_recoveries.pdf', dpi=300, bbox_inches='tight')
plt.show()
